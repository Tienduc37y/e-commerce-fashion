...
const ConfirmDeleteProductDialog = ({ open, onClose, onConfirm, productName }) => {
  return (
        ...
        <Paper elevation={3} sx={{ backgroundColor: 'background.paper' }}>
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description" sx={{ color: 'text.primary' }}>
              Bạn có chắc chắn muốn xóa sản phẩm <strong className='text-red-500'>{productName}</strong> không? Hành động này không thể hoàn tác.
            </DialogContentText>
          </DialogContent>
