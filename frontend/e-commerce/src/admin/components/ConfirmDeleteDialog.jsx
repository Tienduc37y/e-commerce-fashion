...
const ConfirmDeleteDialog = ({ open, onClose, onConfirm, userName }) => {
  return (
        ...
        <Paper elevation={3} sx={{ backgroundColor: 'background.paper' }}>
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description" sx={{ color: 'text.primary' }}>
              Bạn có chắc chắn muốn xóa người dùng <strong className='text-red-500'>{userName}</strong> không? Hành động này không thể hoàn tác.
            </DialogContentText>
          </DialogContent>
